...
namespace TheBox.Pages
{
	...
	/// </summary>
	public class General : System.Windows.Forms.UserControl
	{
		private System.Windows.Forms.LinkLabel lnkSound;
		...
		private System.Windows.Forms.ComboBox cmbSpeech;
		private System.Windows.Forms.ComboBox cmbWeb;
		private System.Windows.Forms.Button bTell;
		private System.Windows.Forms.Button bSM;
		private System.Windows.Forms.Button bBCast;
		private System.Windows.Forms.Button bWeb;
		private System.Windows.Forms.Button bPriv;
		private System.Windows.Forms.Button bSound;
		private System.Windows.Forms.GroupBox groupBox4;
		private System.Windows.Forms.LinkLabel lnkSkill;
		private System.Windows.Forms.NumericUpDown numSkill;
		private System.Windows.Forms.Button bGetSkill;
		private System.Windows.Forms.Button bSetSkill;
		private System.Windows.Forms.GroupBox groupBox5;
		private System.Windows.Forms.CheckBox chkDupe;
		private System.Windows.Forms.NumericUpDown numDupe;
		private System.Windows.Forms.Button bDupe;
		private System.Windows.Forms.Button bInBag;
		private System.Windows.Forms.GroupBox groupBox6;
		private System.Windows.Forms.Button bLightGlobal;
		private System.Windows.Forms.Button bLightLocal;
		...
		private void General_Load(object sender, System.EventArgs e)
		{
			...
			{
				// Sounds
				Pandora.SoundData.SoundChanged += new EventHandler(SoundData_SoundChanged);
				UpdateSound();
				bPriv.Tag = new CommandCallback( PerformPrivSound );
				bPriv.ContextMenu = Pandora.cmModifiers;

				// Skills
				Pandora.Skills.AllSkillsSelected += new EventHandler(Skills_AllSkillsSelected);
				Pandora.Skills.SkillSelected += new TheBox.Data.SkillsData.SkillEventHandler(Skills_SkillSelected);
		...
		/// </summary>
		private void lnkSound_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
		...
		/// PrivSound button
		/// </summary>
		private void bPriv_Click(object sender, System.EventArgs e)
		{
		...
		/// Sound button
		/// </summary>
		private void bSound_Click(object sender, System.EventArgs e)
		{
			if ( Pandora.Profile.General.Sound != null )
			{
		...
		/// Set skill clicked
		/// </summary>
		private void bSetSkill_Click(object sender, System.EventArgs e)
		{
			UpdateSkillValue();
		...
		/// Get skill clicked
		/// </summary>
		private void bGetSkill_Click(object sender, System.EventArgs e)
		{
			UpdateSkillValue();
		...
		/// </summary>
		private void numSkill_ValueChanged(object sender, System.EventArgs e)
		{
			UpdateSkillValue();
		}
		...
		/// </summary>
		private void numDupe_ValueChanged(object sender, System.EventArgs e)
		{
			UpdateDupeAmount();
		}
		...
		/// Dupe Check changed
		/// </summary>
		private void chkDupe_CheckedChanged(object sender, System.EventArgs e)
		{
		...
		/// Dupe button
		/// </summary>
		private void bDupe_Click(object sender, System.EventArgs e)
		{
		...
		/// Dupe in bag button
		/// </summary>
		private void bInBag_Click(object sender, System.EventArgs e)
		{
		...
		/// </summary>
		private void numLight_ValueChanged(object sender, System.EventArgs e)
		{
			UpdateLightLevel();
		}
		...
		/// Global Light button
		/// </summary>
		private void bLightGlobal_Click(object sender, System.EventArgs e)
		{
			UpdateLightLevel();
		...
		/// Local light button
		/// </summary>
		private void bLightLocal_Click(object sender, System.EventArgs e)
		{
			UpdateLightLevel();
		...
		/// Tell button
		/// </summary>
		private void bTell_Click(object sender, System.EventArgs e)
		{
			PerformTell( null );
		}
		...
		/// </summary>
		private void bSM_Click(object sender, System.EventArgs e)
		{
			if ( cmbSpeech.Text != null && cmbSpeech.Text.Length > 0 )
			{
		...
		/// Broadcast button
		/// </summary>
		private void bBCast_Click(object sender, System.EventArgs e)
		{
			if ( cmbSpeech.Text != null && cmbSpeech.Text.Length > 0 )
			{
		...
		private void RefreshWebMenu()
		{
			...
			if ( Pandora.Profile.General.WebPresets.Count > 0 )
			{
				...
				foreach ( string url in Pandora.Profile.General.WebPresets )
				{
					MenuItem mi = new MenuItem( url );
					mi.Click += new EventHandler(SelectWebPreset);
					m_WebMenu.MenuItems.Add( mi );
				}
			}

			m_WebMenu.Popup += new EventHandler(m_WebMenu_Popup);
		...
		private void RefreshSpeechMenu()
		{
			...
			if ( Pandora.Profile.General.SpeechPresets.Count > 0 )
			{
				...
				foreach ( string speech in Pandora.Profile.General.SpeechPresets )
				{
					MenuItem mi = new MenuItem( speech );
					mi.Click += new EventHandler(SelectSpeechPreset);
					m_SpeechMenu.MenuItems.Add( mi );
				}
			}

			m_SpeechMenu.Popup += new EventHandler(m_SpeechMenu_Popup);
		...
		{
			TheBox.Forms.StringListForm form = new TheBox.Forms.StringListForm();
		...
		{
			foreach( string s in Pandora.Profile.General.WebPresets )
			{
		...
		{
			foreach( string s in Pandora.Profile.General.SpeechPresets )
			{
