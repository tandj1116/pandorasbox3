...
namespace TheBox.Pages
{
	...
	/// </summary>
	public class Props : System.Windows.Forms.UserControl
	{
		private System.Windows.Forms.TreeView tProps;
		private System.Windows.Forms.TreeView tClasses;
		private System.Windows.Forms.ComboBox cmbFilter;
		private System.Windows.Forms.CheckBox chkAllClasses;
		private System.Windows.Forms.CheckBox chkAllProps;
		...
		private TheBox.Controls.TimeSpanControl cTimeSpan;
		...
		/// </summary>
		private bool m_ApplyingOptions = false;
		
		/// <summary>
		/// The property currently selected
		/// </summary>
		private BoxProp m_SelectedProperty = null;
		private System.Windows.Forms.Label labMsg;
		private TheBox.Controls.BooleanControl cBoolean;
		private TheBox.Controls.DateTimeControl cDateTime;
		private TheBox.Controls.Point3DControl cPoint3D;
		private TheBox.Controls.EnumControl cEnum;
		...
		/// </summary>
		private Control m_VisibleControl = null;
		...
		private void Props_Load(object sender, System.EventArgs e)
		{
			try
			{
				...
				PropsData.PropsChanged += new EventHandler(PropsData_PropsChanged);
			}
			catch
			{
			}
		...
		private TreeNode[] GetPropNodes( TreeNode cNode )
		{
			...
			if ( Pandora.Profile.Props.ShowAllProps )
			{
				...
				TreeNode[] tNodes = new TreeNode[ nodes.Count ];
		...
		// Issue 10 - End
		{
			...
			{
				TreeNode found = NodeExists( n.Text, from );
		...
		/// </summary>
		private void chkAllClasses_CheckedChanged(object sender, System.EventArgs e)
		{
		...
		/// </summary>
		private void chkAllProps_CheckedChanged(object sender, System.EventArgs e)
		{
			if ( m_ApplyingOptions )
				return;
		...
		private void bFind_Click(object sender, System.EventArgs e)
		{
			if ( cmbSearch.Text != null && cmbSearch.Text.Length > 0 )
			{
				...
				{
					TheBox.Forms.SearchResultsSelector selector = new TheBox.Forms.SearchResultsSelector();
		...
		private void DisplaySearchResult( string path )
		{
			...
			TreeNode PreviousNode = FindNode( NodePath[ 0 ], tClasses.Nodes );

			for ( int i = 1; i < NodePath.Length; i++ )
			{
				TreeNode node = FindNode( NodePath[ i ], PreviousNode.Nodes );
		...
		private void tClasses_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			TreeView view = sender as TreeView;

			view.SelectedNode = view.GetNodeAt( view.PointToClient( Control.MousePosition ) );
