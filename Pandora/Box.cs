...
namespace TheBox
{
	...
	/// </summary>
	public class Box : System.Windows.Forms.Form, IBoxForm
	{
		...
		{
			Profile p = _profileManager.Profile;
		...
		private void Map_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			if ( e.Button == MouseButtons.Right )
			{
				...
				if ( obj != null && obj is SpawnDrawObject )
				{
					...
					TheBox.Forms.PopUpForm.PopUp( Pandora.BoxForm as Form, "Spawn Details", spawn.Spawn.ToolTipDetailed, true, null );
				}
				else
				{
		...
		private void Box_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			...
			{
                _profileManager.Profile.General.WindowLocation = this.Location;
			}
