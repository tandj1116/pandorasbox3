...
namespace TheBox.Buttons
{
	...
	/// </summary>
	public class BoxMenuEditor : System.Windows.Forms.Form
	{
		/// <summary>
		...
		private System.Windows.Forms.Button bNewSubmenu;
		...
		private System.Windows.Forms.Button bNewCommand;
		...
		/// Add a new submenu
		/// </summary>
		private void bNewSubmenu_Click(object sender, System.EventArgs e)
		{
			...
			TreeNode node = new TreeNode( txSubmenu.Text );
		...
		private void txCaption_TextChanged(object sender, System.EventArgs e)
		{
			...
			{
				MenuCommand mc = Tree.SelectedNode.Tag as MenuCommand;
		...
		/// </summary>
		private void txCommand_TextChanged(object sender, System.EventArgs e)
		{
		...
		/// </summary>
		private void chkPrefix_CheckedChanged(object sender, System.EventArgs e)
		{
			if ( Tree.SelectedNode != null && Tree.SelectedNode.Tag is MenuCommand )
			{
				MenuCommand mc = Tree.SelectedNode.Tag as MenuCommand;
		...
		private ArrayList ProcessTreeNode( TreeNode node )
		{
			...
			foreach ( TreeNode n in node.Nodes )
			{
				...
				{
					GenericNode gn = new GenericNode( n.Text );
			...
			switch ( e.KeyCode )
			{
				...
				case Keys.Up:
					...
					if ( Tree.SelectedNode != null && Tree.SelectedNode != m_MenuNode )
					{
						...
						TreeNode prev = parent.Nodes[ index - 1 ];
				...
				case Keys.Down:
					...
					if ( Tree.SelectedNode != null && Tree.SelectedNode != m_MenuNode )
					{
						...
						TreeNode next = parent.Nodes[ index + 1 ];
		...
		private void txCommand_Enter(object sender, System.EventArgs e)
		{
			if ( txCaption.Text.Length > 0 && txCommand.Text.Length == 0 )
			{
		...
		private void txCommand_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void txSubmenu_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			if ( e.KeyCode == Keys.Enter )
			{
				e.Handled = true;
