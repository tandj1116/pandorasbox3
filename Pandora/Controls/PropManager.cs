...
namespace TheBox.Controls
{
	...
	/// </summary>
	public class PropManager : System.Windows.Forms.UserControl
	{
		...
		private System.Windows.Forms.ContextMenu cmFilters;

		private TheBox.Forms.FilterBuilder m_FilterForm;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(PropManager));
		...
		private TheBox.Options.PropsOptions Options
		{
			get { return Pandora.Profile.Props; }
		}
		...
		private void bGet_Click(object sender, System.EventArgs e)
		{
		...
		private void cbProps_Enter(object sender, System.EventArgs e)
		{
			if ( cbProps.Text.Length > 0 )
			{
				cbProps.SelectAll();
		...
		private void cbValue_Enter(object sender, System.EventArgs e)
		{
		...
		private void imgFilter_Click(object sender, System.EventArgs e)
		{
			if ( m_FilterForm == null )
			{
				m_FilterForm = new TheBox.Forms.FilterBuilder();
				m_FilterForm.Closed += new EventHandler(m_FilterForm_Closed);
				m_FilterForm.Show();
			}
			else
			{
		...
		{
			cmFilters.MenuItems[ 0 ].Enabled = 
				cbType.Text.Length > 0
				&& ! Pandora.Profile.Props.Filters.Contains( cbType.Text );
