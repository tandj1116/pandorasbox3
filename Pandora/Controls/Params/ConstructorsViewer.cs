...
namespace TheBox.Controls.Params
{
	...
	/// </summary>
	public class ConstructorsViewer : System.Windows.Forms.UserControl
	{
		...
		private System.Windows.Forms.Label labNoCtors;
		/// <summary> 
		...
		/// </summary>
		private void ConstructorsViewer_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			// Paint the border
		...
		private void ConstructorsViewer_EnumValueChanged(object sender, EventArgs e)
		{
			...
			{
				int index = m_CurrentCtor.Param1.EnumValues.IndexOf( m_Param1.Value );

				ItemDef def = m_CurrentCtor.List1[ index ] as ItemDef;
