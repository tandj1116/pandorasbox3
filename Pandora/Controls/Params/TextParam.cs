...
namespace TheBox.Controls.Params
{
	...
	/// </summary>
	public class TextParam : System.Windows.Forms.UserControl, IParam
	{
		private static string m_Text = "";
		private static string m_Other = "";

		private bool m_IsOther = false;
		...
		private void TextParam_Load(object sender, System.EventArgs e)
		{
			if ( m_IsOther )
			{
				tx.Text = m_Other;
		...
		private void tx_TextChanged(object sender, System.EventArgs e)
		{
			if ( m_IsOther )
			{
				m_Other = tx.Text;
