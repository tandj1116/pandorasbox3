...
namespace TheBox.Controls
{
	...
	/// </summary>
	public class TimeSpanControl : System.Windows.Forms.UserControl
	{
		...
		private void TimeSpanControl_Load(object sender, System.EventArgs e)
		{
			try
			{
				TheBox.Options.PropsOptions p = Pandora.Profile.Props;
