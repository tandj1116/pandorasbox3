...
namespace TheBox.Controls
{
	...
	/// </summary>
	public class DecoMover : System.Windows.Forms.UserControl
	{
		...
		private bool m_EventMode = false;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(DecoMover));
			...
			this.num.Maximum = new System.Decimal(new int[] {
																				...
																				0,
																				0});
			this.num.Minimum = new System.Decimal(new int[] {
																				1,
																				0,
																				0,
																				0});
			...
			this.num.TabIndex = 1;
			this.num.Value = new System.Decimal(new int[] {
																			 1,
																			 0,
																			 0,
																			 0});
		...
		private void PerformMove( string modifier, int xMultiplier, int yMultiplier )
		{
			...
			int x = xMultiplier * Pandora.Profile.Deco.MoveAmount;
			int y = yMultiplier * Pandora.Profile.Deco.MoveAmount;
		...
		private void DecoMover_Load(object sender, System.EventArgs e)
		{
			try
			{
		...
		private void bUpLeft_Click(object sender, System.EventArgs e)
		{
			UpLeft( null );
		}
		...
		private void bUpRight_Click(object sender, System.EventArgs e)
		{
			UpRight( null );
		}
		...
		private void bDownLeft_Click(object sender, System.EventArgs e)
		{
			DownLeft( null );
		}
		...
		private void bDownRight_Click(object sender, System.EventArgs e)
		{
			DownRight( null );
		}
	}
