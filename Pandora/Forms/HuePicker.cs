...
namespace TheBox.Forms
{
	...
	/// </summary>
	public class HuePicker : System.Windows.Forms.Form
	{
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.Label label2;
		private System.Windows.Forms.Label label3;
		private System.Windows.Forms.Label label4;
		private TheBox.Common.HuesChart Chart;
		private System.Windows.Forms.NumericUpDown numIndex;
		private System.Windows.Forms.Label labName;
		private TheBox.ArtViewer.ArtViewer Art;
		private System.Windows.Forms.PictureBox imgSpectrum;
		private System.Windows.Forms.TrackBar barDarkness;
		...
		private System.Windows.Forms.LinkLabel lnkZero;
		...
		private void HuePicker_Load(object sender, System.EventArgs e)
		{
			// Preview
		...
		private void Chart_HueChanged(object sender, System.EventArgs e)
		{
			// Spectrum
		...
		{
			Art.Art = (ArtViewer.Art) comboType.SelectedIndex;
			Pandora.Profile.Hues.Art = Art.Art;
		}

		private void numID_ValueChanged(object sender, System.EventArgs e)
		{
		...
		private void chkRoom_CheckedChanged(object sender, System.EventArgs e)
		{
		...
		private void numIndex_ValueChanged(object sender, System.EventArgs e)
		{
		...
		private void barDarkness_Scroll(object sender, System.EventArgs e)
		{
			Chart.ColorTableIndex = barDarkness.Value;
		...
		private void lnkZero_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			numIndex.Value = 0;
			// SelectedHue = 0;
		}

		private void HuePicker_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			e.Cancel = true;
			Visible = false;
		}
