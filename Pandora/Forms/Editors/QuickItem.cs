...
namespace TheBox.Forms.Editors
{
	...
	/// </summary>
	public class QuickItem : System.Windows.Forms.Form
	{
		private System.Windows.Forms.Button bCancel;
		private System.Windows.Forms.Button bOk;
		private TheBox.ArtViewer.ArtViewer m_Preview;
		...
		private TheBox.Data.BoxItem m_Item;
		private TheBox.Data.BoxItem m_Backup;

		/// <summary>
		/// Gets or sets the object being edited
		/// </summary>
		public TheBox.Data.BoxItem Item
		{
			get
			{
				return m_Item;
			...
			set
			{
				m_Backup = value.Clone() as TheBox.Data.BoxItem;
				m_Item = value;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(QuickItem));
		...
		private void QuickItem_Load(object sender, System.EventArgs e)
		{
			m_Preview.BackColor = Pandora.Profile.General.ArtBackground.Color;

			if ( m_Item == null )
			{
				m_Item = new TheBox.Data.BoxItem();
				m_Item.EmptyCtor = true;

				pGrid.SelectedObject = m_Item;

				m_Backup = new TheBox.Data.BoxItem();
			}
			else
			{
