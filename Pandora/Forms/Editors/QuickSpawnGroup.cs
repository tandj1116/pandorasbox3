...
namespace TheBox.Forms.Editors
{
	...
	/// </summary>
	public class QuickSpawnGroup : System.Windows.Forms.Form
	{
		...
		public QuickSpawnGroup()
		{
			...
			dGrid.CaptionText = Pandora.TextProvider[ "Spawns.List" ];
		}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(QuickSpawnGroup));
		...
		/// </summary>
		private void QuickSpawnGroup_Load(object sender, System.EventArgs e)
		{
		...
		private void bAddType_Click(object sender, System.EventArgs e)
		{
			if ( txType.Text.Length > 0 )
			{
				...
				if ( exists )
				{
					MessageBox.Show( Pandora.TextProvider[ "Spawns.Exists" ] );
				}
				else
				{
					// Actually add
		...
		private void dGrid_DragEnter(object sender, System.Windows.Forms.DragEventArgs e)
		{
		...
		private void txType_DragDrop(object sender, System.Windows.Forms.DragEventArgs e)
		{
			string type = e.Data.GetData( DataFormats.Text ).ToString();
			txType.Text = type;
		}
		...
		private void bDelete_Click(object sender, System.EventArgs e)
		{
			...
			{
				int index = dGrid.CurrentCell.RowNumber;
		...
		private void bOk_Click(object sender, System.EventArgs e)
		{
			...
			{
				MessageBox.Show( Pandora.TextProvider[ "Spawns.NoName" ] );
			}
			else if ( m_Spawn.Entries.Count == 0 )
			{
				MessageBox.Show( Pandora.TextProvider[ "Spawns.Empty" ] );
			}
			else
			{
