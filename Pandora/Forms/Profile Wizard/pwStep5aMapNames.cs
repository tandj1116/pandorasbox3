...
{
	public class pwStep5MapNames : TSWizards.BaseInteriorStep
	{
		...
		private void chk0_CheckedChanged(object sender, System.EventArgs e)
		{
		...
		private void chk3_CheckedChanged(object sender, System.EventArgs e)
		{
			tx3.Enabled = chk3.Checked;
			m_EnabledMaps[3] = chk3.Checked;
		}

		private bool[] m_EnabledMaps = new bool[] { false, false, false, false , false};
		private string[] m_MapNames = new string[] { "Felucca", "Trammel", "Ilshenar", "Malas", "Tokuno" };
		...
		private void tx0_TextChanged(object sender, System.EventArgs e)
		{
		...
		private void tx3_TextChanged(object sender, System.EventArgs e)
		{
		...
		private void tx4_TextChanged(object sender, System.EventArgs e)
		{
