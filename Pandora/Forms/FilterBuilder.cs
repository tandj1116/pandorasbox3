...
namespace TheBox.Forms
{
	...
	/// </summary>
	public class FilterBuilder : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.CheckBox chkPresets;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(FilterBuilder));
		...
		{
			TheBox.Common.Utility.DrawBorder( sender as Control, e.Graphics );
		}

		private void FilterBuilder_Load(object sender, System.EventArgs e)
		{
		...
		private void UpdateOutput()
		{
			...
			foreach( string s in m_Conditions )
			{
				m_Filter += " " + s;
			}
		...
		private void cmbType_TextChanged(object sender, System.EventArgs e)
		{
			UpdateOutput();
		}
		...
		{
			string cond = string.Format( "{0}{1}{2}", cmbProp.Text, cmbOp.Text, cmbValue.Text );
		...
		private void cmbProp_TextChanged(object sender, System.EventArgs e)
		{
			EnableProps();
		}

		private void cmbValue_TextChanged(object sender, System.EventArgs e)
		{
			EnableProps();
		}
		...
		private void bDel_Click(object sender, System.EventArgs e)
		{
		...
		private void cmbType_DragEnter(object sender, System.Windows.Forms.DragEventArgs e)
		{
		...
		private void cmbType_DragDrop(object sender, System.Windows.Forms.DragEventArgs e)
		{
		...
		/// </summary>
		public bool AddToPresets
		{
			get { return chkPresets.Checked; }
		}
	}
}
