...
namespace Box.Misc
{
	...
	/// </summary>
	public class PB1ImportForm : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(PB1ImportForm));
			...
			this.label1.Text = "You are importing a file from Pandora\'s Box 1 that doesn\'t contain map informatio" +
				"n or that contains locations for different maps. Please select which map should " +
				"be extracted.";
			// 
			// button1
			// 
