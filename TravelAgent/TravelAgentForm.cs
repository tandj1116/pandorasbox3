...
namespace TheBox.TravelAgent
{
	...
	/// </summary>
	public class TravelAgentForm : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Button bAddLoc;
		private System.Windows.Forms.LinkLabel lnk0;
		...
		private System.Windows.Forms.RadioButton rMap;
		private System.Windows.Forms.RadioButton rManually;
		...
		private TheBox.MapViewer.MapViewer m_Map;
		private System.Windows.Forms.ContextMenu cmCat;
		private System.Windows.Forms.ContextMenu cmLoc;
		private System.Windows.Forms.MenuItem miCatRename;
		private System.Windows.Forms.MenuItem miCatDelete;
		private System.Windows.Forms.MenuItem miLocRename;
		private System.Windows.Forms.MenuItem miLocDelete;
		private System.Windows.Forms.MenuItem menuItem2;
		private System.Windows.Forms.MenuItem miUpdateClient;
		private System.Windows.Forms.MenuItem miUpdateMap;
		private System.Windows.Forms.FolderBrowserDialog BrowseFolder;
		private System.Windows.Forms.OpenFileDialog OpenFile;
		private System.Windows.Forms.MenuItem miLocUpdate;
		...
		private void lnk0_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			m_Map.Map = Maps.Felucca;
		}

		private void lnk1_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			m_Map.Map = Maps.Trammel;
		}

		private void lnk2_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			m_Map.Map = Maps.Ilshenar;
		}

		private void lnk3_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			m_Map.Map = Maps.Ilshenar;
		}
		...
		private void txCat_TextChanged(object sender, System.EventArgs e)
		{
			EnableButtons();
		}

		private void txLoc_TextChanged(object sender, System.EventArgs e)
		{
			EnableButtons();
		}
		...
		{
			bool addCat = txCat.Text.Length > 0;
			...
			bool addLoc = txLoc.Text.Length > 0;
		...
		{
			TreeNode node = new TreeNode( txCat.Text );
		...
		private void txCat_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e)
		{
		...
		private void m_Map_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
		...
		private Facet CurrentFacet
		{
			get
			{
				...
				{
					GenericNode gCat = new GenericNode( cat.Text );
			...
			set
			{
				...
				foreach( GenericNode gCat in value.Nodes )
				{
					TreeNode cat = new TreeNode( gCat.Name );
		...
		private void miOpen_Click(object sender, System.EventArgs e)
		{
			...
			{
				Facet f = Utility.LoadXml( typeof( Facet ), OpenFile.FileName ) as Facet;
		...
		private void cmLoc_Popup(object sender, System.EventArgs e)
		{
		...
		private void miLocRename_Click(object sender, System.EventArgs e)
		{
		...
		private void miUpdateClient_Click(object sender, System.EventArgs e)
		{
		...
		private void miUpdateMap_Click(object sender, System.EventArgs e)
		{
		...
		private void Merge( Facet f )
		{
			...
			foreach( GenericNode cat in f.Nodes )
			{
		...
		private void TravelAgentForm_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			CheckModified();
		}
		...
		private void miImport_Click(object sender, System.EventArgs e)
		{
			...
			if ( OpenFile.ShowDialog() == DialogResult.OK )
			{
				Facet f = Box.Misc.PB1Import.Convert( OpenFile.FileName );
