...
{
	public class BoxServerSetup : TSWizards.BaseWizard
	{
		...
		public BoxServerSetup()
		{
			...
			this.AddStep( "Introduction", new Introduction() );
			this.AddStep( "S1_Folder", new S1_Folder() );
			this.AddStep( "S2_BoxFolder", new S2_BoxFolder() );
			this.AddStep( "S3_Spawner", new S3_Spawner() );
			this.AddStep( "S4_Modules", new S4_Modules() );
			this.AddStep( "S5_Install", new S5_Install() );
			this.AddStep( "Finish", new Finish() );
		}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(BoxServerSetup));
			// 
			// wizardTop
			// 
