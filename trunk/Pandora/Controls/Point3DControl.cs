...
namespace TheBox.Controls
{
	...
	/// </summary>
	public class Point3DControl : System.Windows.Forms.UserControl
	{
		...
		private void Point3DControl_Load(object sender, System.EventArgs e)
		{
			try
			{
		...
		{
			string s = string.Format( "{0} {1} {2}", Pandora.Profile.Props.PointX, Pandora.Profile.Props.PointY, Pandora.Profile.Props.PointZ );
