...
namespace TheBox.Controls.Params
{
	...
	/// </summary>
	public class Point3DForm : System.Windows.Forms.Form
	{
		private static int m_X = 0;
		private static int m_Y = 0;
		private static int m_Z = 0;
		...
		public Point3DForm( int x, int y, int z ) : this()
		{
			m_X = x;
			m_Y = y;
			m_Z = z;
		...
		private void InitializeComponent()
		{
			...
			this.numX.Maximum = new System.Decimal(new int[] {
																				 7000,
																				 0,
																				 0,
																				 0});
			...
			this.numY.Maximum = new System.Decimal(new int[] {
																				 7000,
																				 0,
																				 0,
																				 0});
		...
		private void Point3DForm_Load(object sender, System.EventArgs e)
		{
			PointX = m_X;
			PointY = m_Y;
			PointZ = m_Z;
		...
		private void Point3DForm_Leave(object sender, System.EventArgs e)
		{
			Close();
		}

		private void Point3DForm_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
		...
		private void Point3DForm_Deactivate(object sender, System.EventArgs e)
		{
			Close();
		}
		...
		public int PointZ
		{
			get { return (int) numZ.Value; }
			set { numZ.Value = value; }
		}
		...
		{
			get { return string.Format( "({0},{1},{2})", PointX, PointY,PointZ ); }
		}
	}
}
