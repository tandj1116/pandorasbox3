...
namespace TheBox.Roofing
{
	...
	/// </summary>
	public class RoofingForm : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.ComboBox cmbSlope;
		...
		private System.Windows.Forms.Button bServerGenerate;
		private System.Windows.Forms.Button bServerControl;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(RoofingForm));
			...
			this.lnkFromClient2.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.lnkFromClient1_LinkClicked);
			// 
			// label4
			// 
		...
		/// Slope check changed
		/// </summary>
		private void chkSlope_CheckedChanged(object sender, System.EventArgs e)
		{
			UpdateSlopeCombo();
		}
		...
		private RoofRect CurrentRect
		{
			get
			{
				...
				int x1 = (int) n1X.Value;
				int y1 = (int) n1Y.Value;
				int x2 = (int) n2X.Value;
				int y2 = (int) n2Y.Value;
		...
		private void RoofingForm_Load(object sender, System.EventArgs e)
		{
			...
			foreach( TileSet tileset in m_RoofTiles )
			{
			...
			m_Roof.RoofImageChanged += new EventHandler(m_Roof_RoofImageChanged);
		}
		...
		/// </summary>
		private void cmbTiles_SelectedIndexChanged(object sender, System.EventArgs e)
		{
		...
		{
			m_Roof.GenerateClassic( Roof.TestMode.NoTest, (int) numHeight.Value, chkHue.Checked ? Pandora.Profile.Hues.SelectedIndex : 0 );
		}
		...
		private void bTest_Click(object sender, System.EventArgs e)
		{
			if ( m_Roof.GenerateClassic( Roof.TestMode.Test, (int) numHeight.Value, chkHue.Checked ? Pandora.Profile.Hues.SelectedIndex : 0 ) )
			{
				...
				{
					m_Roof.GenerateClassic( Roof.TestMode.Rest, (int) numHeight.Value, chkHue.Checked ? Pandora.Profile.Hues.SelectedIndex : 0 );
				}
			}
		}
		...
		/// </summary>
		private void bServerGenerate_Click(object sender, System.EventArgs e)
		{
			m_Roof.GenerateThroughServer( (int) numHeight.Value, chkHue.Checked ? Pandora.Profile.Hues.SelectedIndex : 0 );
		}

		private void bServerControl_Click(object sender, System.EventArgs e)
		{
