...
namespace TheBox.Data
{
	...
	public class RandomTiles
	{
		...
		public void Save()
		{
			TheBox.Common.Utility.SaveXml( this, System.IO.Path.Combine( Pandora.Profile.BaseFolder, "RandomTiles.xml" ) );
		}
		...
		{
			return TheBox.Common.Utility.LoadXml( typeof( RandomTiles ), System.IO.Path.Combine( Pandora.Profile.BaseFolder, "RandomTiles.xml" ) ) as RandomTiles;
		}
	}
	...
	public class RandomTilesList
	{
		...
		public RandomTilesList( string name ) : this()
		{
			m_Name = name;
		}
