...
namespace TheBox.Buttons
{
	...
	/// </summary>
	public class MultiCommandEditor : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(MultiCommandEditor));
		...
		private void Tree_AfterCheck(object sender, System.Windows.Forms.TreeViewEventArgs e)
		{
			if ( e.Node.Checked )
			{
				...
				if ( m_Def.DefaultIndex >= 0 && m_Def.DefaultIndex < Tree.Nodes.Count )
				{
					...
					{
						TreeNode node = Tree.Nodes[ m_Def.DefaultIndex ];
		...
		private void Tree_AfterSelect(object sender, System.Windows.Forms.TreeViewEventArgs e)
		{
			if ( m_Edit )
			{
				MenuCommand mc = e.Node.Tag as MenuCommand;
		...
		/// Preview the menu
		/// </summary>
		private void linkPreview_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			DoDef();
