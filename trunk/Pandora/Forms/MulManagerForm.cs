...
namespace TheBox.Forms
{
	...
	/// </summary>
	public class MulManagerForm : System.Windows.Forms.Form
	{
		/// <summary>
		...
		private System.Windows.Forms.Label labDefFolder;
		private System.Windows.Forms.GroupBox groupBox2;
		private System.Windows.Forms.Label labCustFolder;
		private System.Windows.Forms.Button bSetCust;
		private System.Windows.Forms.Button bClearCust;
		private System.Windows.Forms.FolderBrowserDialog FolderBrowser;
		private System.Windows.Forms.OpenFileDialog FileBrowser;
		private System.Windows.Forms.Label labFile;
		private System.Windows.Forms.Button bChangeFile;
		private System.Windows.Forms.Button bDefaulFile;
		private System.Windows.Forms.Button bClose;
		private System.Windows.Forms.GroupBox grp;
		private System.Windows.Forms.Label label1;

		private MulManager m_Manager;
		private TextProvider m_Text;
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(MulManagerForm));
		...
		private void MulManagerForm_Load(object sender, System.EventArgs e)
		{
			foreach( string s in m_Manager.SupportedFiles )
			{
				lst.Items.Add( s );
			}
		...
		private void bSetCust_Click(object sender, System.EventArgs e)
		{
		...
		private void bClearCust_Click(object sender, System.EventArgs e)
		{
			m_Manager.CustomFolder = null;
			labCustFolder.Text = m_Text[ "Common.None" ];
		}

		private void labFile_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			TheBox.Common.Utility.DrawBorder( labFile, e.Graphics );
		}
		...
		private void bChangeFile_Click(object sender, System.EventArgs e)
		{
		...
		private void bDefaulFile_Click(object sender, System.EventArgs e)
		{
			m_Manager[ File ] = null;
			File = m_File;
		}
		...
		{
			TheBox.Common.Utility.DrawBorder( label1, e.Graphics );
		}
	}
}
