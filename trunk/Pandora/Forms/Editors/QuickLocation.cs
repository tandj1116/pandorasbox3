...
namespace TheBox.Forms.Editors
{
	...
	/// </summary>
	public class QuickLocation : System.Windows.Forms.Form
	{
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(QuickLocation));
		...
		public int MapFile
		{
			set { Map.Map = (MapViewer.Maps) value; }
		}
	}
}