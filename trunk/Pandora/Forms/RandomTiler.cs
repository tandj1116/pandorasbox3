...
namespace TheBox.Forms
{
	...
	/// </summary>
	public class RandomTiler : System.Windows.Forms.Form
	{
		private System.Windows.Forms.ComboBox cmbTileSet;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.GroupBox groupBox1;
		private System.Windows.Forms.LinkLabel lnkEditTile;
		private System.Windows.Forms.RadioButton rNoHue;
		private System.Windows.Forms.RadioButton rSelectedHue;
		private System.Windows.Forms.RadioButton rRandomHue;
		private System.Windows.Forms.ComboBox cmbHues;
		...
		private System.Windows.Forms.Button bRunSingle;
		private System.Windows.Forms.GroupBox groupBox3;
		private System.Windows.Forms.LinkLabel lnkFromClient2;
		private System.Windows.Forms.Label label4;
		private System.Windows.Forms.Label label3;
		private System.Windows.Forms.NumericUpDown n2Y;
		private System.Windows.Forms.NumericUpDown n2X;
		private System.Windows.Forms.GroupBox groupBox2;
		private System.Windows.Forms.LinkLabel lnkFromClient1;
		private System.Windows.Forms.Label label5;
		private System.Windows.Forms.Label label6;
		private System.Windows.Forms.NumericUpDown n1Y;
		private System.Windows.Forms.NumericUpDown n1X;
		private System.Windows.Forms.Label label7;
		private System.Windows.Forms.Label labFill;
		private System.Windows.Forms.TrackBar slideFill;
		private System.Windows.Forms.Button bAreaRun;
		...
		private System.Windows.Forms.TrackBar pBarFill2;
		private System.Windows.Forms.Label labFill2;
		private System.Windows.Forms.Button bRunBrush;
		...
		private void lnkEditTile_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			m_TileForm = new RandomTileTemplate();
			m_TileForm.Closed += new EventHandler(m_TileForm_Closed);
		...
		private void linkLabel1_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			...
			m_HueForm.Closed += new EventHandler(m_HueForm_Closed);
		...
		private void m_HueForm_Closed(object sender, EventArgs e)
		{
			...
			foreach( HuesCollection hc in hues.Groups )
			{
		...
		{
			TheBox.Common.Utility.DrawBorder( labFill, e.Graphics );
		}

		private void slideFill_Scroll(object sender, System.EventArgs e)
		{
			UpdateFillText();
		}

		private void lnkFromClient1_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			...
			if ( Ultima.Client.FindLocation( ref x, ref y, ref z, ref map ) )
			{
				n1X.Value = x;
				n1Y.Value = y;
			}
		...
		private void lnkFromClient2_LinkClicked(object sender, System.Windows.Forms.LinkLabelLinkClickedEventArgs e)
		{
			Ultima.Client.Calibrate();
		...
		private void labWidth_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			TheBox.Common.Utility.DrawBorder( labWidth, e.Graphics );
		}

		private void pBarFill2_Scroll(object sender, System.EventArgs e)
		{
			UpdateFillText();
		}

		private void labFill2_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			Common.Utility.DrawBorder( labFill2, e.Graphics );
		}

		private void label9_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			Common.Utility.DrawBorder( label9, e.Graphics );
		}
