...
namespace TheBox.Forms
{
	...
	public class ProfileChooser : System.Windows.Forms.Form
	{
		...
		private string m_SelectedProfile = null;
		...
		private void ProfileChooser_Load(object sender, System.EventArgs e)
		{
			TheBox.Common.Utility.BringWindowToFront( this.Handle );
		}
	}
}