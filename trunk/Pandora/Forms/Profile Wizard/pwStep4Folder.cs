...
{
	public class pwStep4Folder : TSWizards.BaseInteriorStep
	{
		...
		private string m_CustomFolder = null;
		...
		{
			TheBox.Forms.MulManagerForm form = new MulManagerForm( (  Wizard as ProfileWizard ).Profile.MulManager, ProfileWizard.TextProvider );
			form.ShowDialog();
		}
	}
}