...
namespace TheBox.Pages
{
	...
	/// </summary>
	public class Tools : System.Windows.Forms.UserControl
	{
		private System.Windows.Forms.GroupBox groupBox1;
		private System.Windows.Forms.TreeView tProgs;
		...
		private System.Windows.Forms.Button bRoofing;
		private System.Windows.Forms.Button bOptions;
		private System.Windows.Forms.Button bLogin;
		private System.Windows.Forms.Button bScriptExplorer;
		private System.Windows.Forms.Button bRndTile;
		private System.Windows.Forms.GroupBox grpServer;
		private System.Windows.Forms.ContextMenu cmDatafiles;
		private System.Windows.Forms.MenuItem miBoxData;
		private System.Windows.Forms.MenuItem miProps;
		private System.Windows.Forms.MenuItem miSpawn;
		private System.Windows.Forms.Button bDatafiles;
		private System.Windows.Forms.Button bClientMap;
		...
		private TheBox.Roofing.RoofingForm m_Roofing;
		...
		private void bRoofing_Click(object sender, System.EventArgs e)
		{
			if ( m_Roofing == null )
			{
				m_Roofing = new TheBox.Roofing.RoofingForm();
				m_Roofing.Closed += new EventHandler(m_Roofing_Closed);
			}
		...
		/// </summary>
		private void Tools_Load(object sender, System.EventArgs e)
		{
			try
			{
				Pandora.Profile.Launcher.OnEntriesChanged += new EventHandler(Launcher_OnEntriesChanged);
				RefreshPrograms();
				EnableServer();
		...
		private void tProgs_DoubleClick(object sender, System.EventArgs e)
		{
			if ( m_Entry != null )
			{
				m_Entry.Run();
		...
		private void bScriptExplorer_Click(object sender, System.EventArgs e)
		{
			if ( m_ScriptExplorer == null )
			{
				...
				{
					m_ScriptExplorer.Closed += new EventHandler(m_ScriptExplorer_Closed);
		...
		private void bRndTile_Click(object sender, System.EventArgs e)
		{
			if ( m_RandomTiler == null )
			{
				m_RandomTiler = new RandomTiler();
				m_RandomTiler.Closed += new EventHandler(m_RandomTiler_Closed);
				m_RandomTiler.Show();
			}
			else
			{
		...
		private void bDatafiles_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
		...
		private void button1_Click(object sender, System.EventArgs e)
		{
			if ( m_ClientMap == null )
			{
				...
				m_ClientMap.Closed += new EventHandler(m_ClientMap_Closed);
				m_ClientMap.Show();
			}
			else
			{
		...
		private void bClientList_Click(object sender, System.EventArgs e)
		{
			if ( m_ClientList == null )
			{
				m_ClientList = new ClientListForm();
				m_ClientList.Closed += new EventHandler(m_ClientList_Closed);
				m_ClientList.Show();
			}
			else
			{
