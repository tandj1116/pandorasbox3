...
namespace TheBox.Pages
{
	...
	/// </summary>
	public class Doors : System.Windows.Forms.UserControl
	{
		/// <summary> 
		/// Required designer variable.
		/// </summary>
		private System.ComponentModel.Container components = null;
		private System.Windows.Forms.LinkLabel lnkDoor;
		private System.Windows.Forms.Label WestCCW;
		private System.Windows.Forms.Label EastCW;
		private System.Windows.Forms.Label WestCW;
		private System.Windows.Forms.Label EastCCW;
		private System.Windows.Forms.Label NorthCW;
		private System.Windows.Forms.Label SouthCCW;
		private System.Windows.Forms.Label NorthCCW;
		private System.Windows.Forms.Label SouthCW;

		private Label m_LabelFocus = null;

		private TheBox.Data.DoorEventArgs m_Door;
		private TheBox.Data.PortcullisEventArgs m_Portcullis;
		...
		private DoorEventArgs Door
		{
			...
			set
			{
				if ( m_Portcullis != null )
				{
					...
					foreach ( Label lab in m_AllLabels )
					{
						lab.Visible = true;
					}
				}
		...
		public Doors()
		{
			...
			try
			{
				m_AllLabels = new Label[]
			{
				WestCW, EastCW, EastCCW, SouthCCW, NorthCCW, SouthCW
			};
		...
		/// Image label paint
		/// </summary>
		private void LabelPaint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
		...
		/// </summary>
		private void LabelEnter(object sender, System.EventArgs e)
		{
		...
		/// </summary>
		private void LabelLeave(object sender, System.EventArgs e)
		{
			m_LabelFocus = null;
			( sender as Label ).Refresh();
		}
		...
		/// </summary>
		private void lnkDoor_Paint(object sender, System.Windows.Forms.PaintEventArgs e)
		{
			Pen pen = new Pen( SystemColors.ControlDark );
		...
		/// </summary>
		private void lnkDoor_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
		...
		/// OnLoad
		/// </summary>
		private void Doors_Load(object sender, System.EventArgs e)
		{
			try
			{
				Pandora.Doors.DoorSelected += new TheBox.Data.DoorEventHandler(Doors_DoorSelected);
				Pandora.Doors.PortcullisSelected += new TheBox.Data.PortcullisEventHandler(Doors_PortcullisSelected);
		...
		/// </summary>
		private void Doors_DoorSelected(TheBox.Data.DoorEventArgs e)
		{
			Door = e;
		}
		...
		/// </summary>
		private void Doors_PortcullisSelected(TheBox.Data.PortcullisEventArgs e)
		{
			Portcullis = e;
		}
		...
		private void Perform( string facing, string modifier )
		{
			...
			{
				string item = string.Format( "{0} {1}", m_Door.Item, facing );
				Pandora.Profile.Commands.DoAddItem( item, modifier );
			}
		}
		...
		/// Labels mouse down
		/// </summary>
		private void WestCCW_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
		...
		private void bUnlock_Click(object sender, System.EventArgs e)
		{
